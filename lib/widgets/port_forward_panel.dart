...
String _forwardModeBadge(PortForwardMode mode) => switch (mode) {
...
String _forwardSummary(AppLocalizations l10n, PortForwardRule rule) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              _ModeBadge(label: _forwardModeBadge(rule.mode)),
