  ...
  testWidgets(
    ...
    (tester) async {
      ...
      final store = ServerStore(
        seed: storeMode == 'empty' ? [] : [testServer()],
      );
      final sessions = SessionManager(store: store);
      addTearDown(sessions.dispose);
      final style = ValueNotifier<TerminalStylePrefs>(
      ...
      final startupJson = <String, Object?>{
        ...
        'maxBuildMs': _r1(
          _maxOf(startupFrames.map((f) => _ms(f.buildDuration))),
        ),
        'maxRasterMs': _r1(
      ...
      List<(String, Widget Function())> componentCases() => [
        ...
        ('TerminalFontDropdown', () => const TerminalFontDropdown()),
        ('TerminalFontSizeControl', () => const TerminalFontSizeControl()),
